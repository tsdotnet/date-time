...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./howMany"], factory);
    }
    ...
    (function (TimeUnit) {
        ...
        function toMilliseconds(value, units) {
            ...
            switch (units) {
                case UnitType.Days:
                    value *= howMany_1.hours.per.day;
                case UnitType.Hours:
                    value *= howMany_1.minutes.per.hour;
                case UnitType.Minutes:
                    value *= howMany_1.seconds.per.minute;
                case UnitType.Seconds:
                    value *= howMany_1.milliseconds.per.second;
                case UnitType.Milliseconds:
                    return value;
                case UnitType.Ticks:
                    return value / howMany_1.ticks.per.millisecond;
                default:
        ...
        function fromMilliseconds(ms, units) {
            switch (units) {
                case UnitType.Days:
                    return ms / howMany_1.milliseconds.per.day;
                case UnitType.Hours:
                    return ms / howMany_1.milliseconds.per.hour;
                case UnitType.Minutes:
                    return ms / howMany_1.milliseconds.per.minute;
                case UnitType.Seconds:
                    return ms / howMany_1.milliseconds.per.second;
                case UnitType.Milliseconds:
                    return ms;
                case UnitType.Ticks:
                    return ms * howMany_1.ticks.per.millisecond;
                default:
                    throw new Error('Invalid TimeUnit.');
            }
        }
