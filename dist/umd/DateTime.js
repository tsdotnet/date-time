...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "@tsdotnet/exceptions", "./ClockTime", "./howMany", "./TimeSpan", "./TimeStamp"], factory);
    }
    ...
    class DateTime {
        ...
        addSeconds(seconds) {
            seconds = seconds || 0;
            return this.addMilliseconds(seconds * howMany_1.milliseconds.per.second);
        }
        addMinutes(minutes) {
            minutes = minutes || 0;
