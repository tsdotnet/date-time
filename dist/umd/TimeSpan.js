...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "@tsdotnet/lazy", "@tsdotnet/type", "./ClockTime", "./howMany", "./TimeQuantity", "./TimeUnit"], factory);
    }
    ...
    class TimeSpan extends TimeQuantity_1.default {
        ...
        constructor(value, units = TimeUnit_1.default.UnitType.Milliseconds) {
            ...
            super(ms);
            this.ticks = ms * howMany_1.ticks.per.millisecond;
            this.milliseconds = ms;
            this.seconds = ms / howMany_1.milliseconds.per.second;
            this.minutes = ms / howMany_1.milliseconds.per.minute;
            this.hours = ms / howMany_1.milliseconds.per.hour;
            this.days = ms / howMany_1.milliseconds.per.day;
